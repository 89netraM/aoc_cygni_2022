...
public class Program
{
	...
	{
		var input = new StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("AoC.Year2022.Day17.input.txt")!).ReadToEnd().Trim();
		Console.WriteLine(Environment.GetEnvironmentVariable("part") == "part2" ? Part2(input) : Part1(input));
	}
	...
	public readonly record struct Vector2(long X, long Y)
	{
